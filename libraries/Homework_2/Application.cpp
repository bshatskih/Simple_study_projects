  ...
  do {
    ...
    switch (operation) {
      ...
      case 2:
        ...
        object1->Add(base2,result);
        std::cout << *dynamic_cast<Money *>(result) << std::endl;
        break;
      case 3:
        std::cout << *object1 << " - " << *object2 << " = ";
        *dynamic_cast<Money *>(result) = object1->Subtract(*object2);
        std::cout << *dynamic_cast<Money *>(result);
        break;
      case 4:
        std::cout << *object1 << " * " << *object2 << " = ";
        *dynamic_cast<Money *>(result) = object1->Multiply(*object2);
        std::cout << *dynamic_cast<Money *>(result);
        break;
      case 5:
        std::cout << *object1 << " / " << *object2 << " = ";
        *dynamic_cast<Money *>(result) = object1->Divide(*object2);
        std::cout << *dynamic_cast<Money *>(result);
        break;
      case 6:
        float a;
        std::cout << "Input nomber:" << std::endl;
        std::cin >> a;
        std::cout << *object1 << " * " << a << " = ";
        *dynamic_cast<Money *>(result) = object1->Multiply(a);
        std::cout << *dynamic_cast<Money *>(result);
        std::cout << std::endl;
        std::cout << *object1 << " / " << a << " = ";
        *dynamic_cast<Money *>(result) = object1->Divide(a);
        std::cout << *dynamic_cast<Money *>(result);
        break;
      case 7:
        if (*object1 == *object2) {
...
void Application::String_run() {
  ...
  do {
    ...
    switch (operation) {
      ...
      case 2:
        std::cout << "'" << *object1 << "'  +  '" << *object2 << "'  =  '";
        object1->Add(object2,dynamic_cast<String *>(result));
      ...
      case 3:
        ...
        *dynamic_cast<String *>(result) = object1->Insert(a, *object2);
        std::cout << *dynamic_cast<String *>(result) << "'" << std::endl;
        break;
      case 4:
        std::cout << "Delete line  '" << *object2 << "'  from line  '" << *object1 << "'  = ";
        *dynamic_cast<String *>(result) = object1->Delete_part_str(*object2);
        std::cout << *dynamic_cast<String *>(result) << "'" << std::endl;
        break;
      case 5:
